...
import io.openleap.LoggingCategories;

/**
 * An MeasuredAspect is used to measure execution time of methods in any application layer annotated with {@link io.openleap.annotation.Measured Measured}.
...
public class MeasuredAspect {
    ...
    /**
     * The execution time is measured of {@link io.openleap.annotation.Measured Measured} annotated,  Around intercepted methods when the log
